// Filename: internal/humanoid/config.go
package humanoid
...
type Config struct {
	...
	GaussianNoiseStdDev                          float64 // Added for applyGaussianNoise in trajectory.go
...
func DefaultConfig() Config {
	c := Config{
		...
		GaussianNoiseStdDev:  0.3, // A reasonable default
