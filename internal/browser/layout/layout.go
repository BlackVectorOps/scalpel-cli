...
func (b *LayoutBox) calculateFlexBaseSizes(items []*FlexItemMetadata, mainAxis, _ Axis, availableMainSize float64, e *Engine) {
...
func (b *LayoutBox) resolveFlexibleLengths(line *FlexLine, availableMainSize float64, _ Axis, _ *Engine) {
...
func (b *LayoutBox) determineCrossSizes(lines []*FlexLine, mainAxis, _ Axis, _ *Engine) {
	for _, line := range lines {
		for _, item := range line.Items {
...
func (b *LayoutBox) isAutoCrossSize(_ *Engine) bool {
...
func (b *LayoutBox) layoutPositioned(e *Engine) {
	...
	resolveW := func(val string) float64 {
		return style.ParseLengthWithUnits(val, fontSize, BaseFontSize, refWidth, vw, vh)
	}
...
func (b *LayoutBox) solvePositionedVerticalConstraints(_ *Engine, pcbBox *LayoutBox, top, height, bottom, marginTop, marginBottom float64) (float64, float64, float64) {
...
func (b *LayoutBox) getStaticPositionX(_ *LayoutBox) float64 {
	return 0.0
}

func (b *LayoutBox) getStaticPositionY(_ *LayoutBox) float64 {
	return 0.0
}
...
func (b *LayoutBox) calculateShrinkToFitWidth(_ *Engine, availableWidth float64) float64 {
	if b.StyledNode != nil {
